...
public class Main {
        public static void main(String[] args) {
            ...
            NumberOfDays calc=new NumberOfDays();
            if (calc.findNumberOfDays(reader.month,reader.year)!=-1){
            System.out.println("Ati solicitat numarul de zile din Luna: " + ReadDate.month + " si Anul " + ReadDate.year + "" +
                    " acesta este: " + calc.findNumberOfDays(reader.month, reader.year));
            }else{
                System.out.println("Month out of this solar system :))))))");
