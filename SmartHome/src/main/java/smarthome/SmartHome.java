...
public class SmartHome {
    public static void main(String[] args) {
        ...
        */
        ...
        /* The following is an alternative code for the above code in order to have concrete objects


        h.setThermostatOn();
        h.setThermostatTemperature(20);
        System.out.println("Thermostat setting is at: "+ h.getTemperature()+" degrees Celsius");
        h.setCameraOn();
        h.setCameraFilmingOn();
        System.out.println("Total energy consumption is: "+h.getTotalEnergyConsumption());
        h.setCameraFilmingOff();
        h.setCameraOff();
        h.setLampOff();
        h.setThermostatOff();
        h.getThermostatStatus();
        h.getSmartLampStatus();
        h.getSmartCameraStatus();
        */
